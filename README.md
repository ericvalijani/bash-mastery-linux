...
Days 01 through 10 ship five worked scripts each. The other 10 `days/dayNN/scripts/` directories are empty on purpose - they are written one day at a time, each run on the real lab before the next is started.
