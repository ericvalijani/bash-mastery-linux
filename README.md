...
Day 01 ships five worked scripts. The other 19 `days/dayNN/scripts/` directories are empty on purpose - they are written one day at a time, each run on the real lab before the next is started.
