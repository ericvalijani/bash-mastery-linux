...
Days 01, 02, 03 and 04 ship five worked scripts each. The other 16 `days/dayNN/scripts/` directories are empty on purpose - they are written one day at a time, each run on the real lab before the next is started.
