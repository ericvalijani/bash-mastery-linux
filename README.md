...
Days 01 through 09 ship five worked scripts each. The other 11 `days/dayNN/scripts/` directories are empty on purpose - they are written one day at a time, each run on the real lab before the next is started.
